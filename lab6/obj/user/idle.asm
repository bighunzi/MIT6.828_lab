...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80049a:	8b 1c 85 f8 22 80 00 	mov    0x8022f8(,%eax,4),%ebx
  ...
  8004b0:	52                   	push   %edx
  8004b1:	50                   	push   %eax
  8004b2:	68 7c 22 80 00       	push   $0x80227c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800702:	56                   	push   %esi
  800703:	50                   	push   %eax
  800704:	68 bd 22 80 00       	push   $0x8022bd
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8007c5:	8b 40 48             	mov    0x48(%eax),%eax
  8007c8:	83 ec 04             	sub    $0x4,%esp
  8007cb:	53                   	push   %ebx
  8007cc:	50                   	push   %eax
  8007cd:	68 d9 22 80 00       	push   $0x8022d9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80086d:	8b 40 48             	mov    0x48(%eax),%eax
		cprintf("[%08x] ftruncate %d -- bad mode\n",
  800870:	83 ec 04             	sub    $0x4,%esp
  800873:	53                   	push   %ebx
  800874:	50                   	push   %eax
  800875:	68 9c 22 80 00       	push   $0x80229c
...
fsipc(unsigned type, void *dstva)
{
  ...
  800964:	e8 b9 15 00 00       	call   801f22 <ipc_send>
  ...
  800982:	e8 ef 15 00 00       	call   801f76 <ipc_find_env>
...
00800a79 <devfile_read>:
{
  ...
  800ace:	c3                   	ret    
	assert(r <= n);
  800acf:	68 0c 23 80 00       	push   $0x80230c
  800ad4:	68 13 23 80 00       	push   $0x802313
  800ad9:	6a 7c                	push   $0x7c
  800adb:	68 28 23 80 00       	push   $0x802328
  800ae0:	e8 e1 09 00 00       	call   8014c6 <_panic>
	assert(r <= PGSIZE);
  800ae5:	68 33 23 80 00       	push   $0x802333
  800aea:	68 13 23 80 00       	push   $0x802313
  800aef:	6a 7d                	push   $0x7d
  800af1:	68 28 23 80 00       	push   $0x802328
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ba6:	68 3f 23 80 00       	push   $0x80233f
...
00800bba <devsock_close>:
{
  ...
  800bc1:	8b 5d 08             	mov    0x8(%ebp),%ebx
	if (pageref(fd) == 1)
  800bc4:	53                   	push   %ebx
  800bc5:	e8 e5 13 00 00       	call   801faf <pageref>
...
nsipc(unsigned type)
{
  ...
  800dcb:	e8 52 11 00 00       	call   801f22 <ipc_send>
  ...
  800de8:	e8 89 11 00 00       	call   801f76 <ipc_find_env>
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  800f69:	c3                   	ret    
		assert(r < 1600 && r <= len);
  800f6a:	68 4b 23 80 00       	push   $0x80234b
  800f6f:	68 13 23 80 00       	push   $0x802313
  800f74:	6a 62                	push   $0x62
  800f76:	68 60 23 80 00       	push   $0x802360
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  800fc7:	c3                   	ret    
	assert(size < 1600);
  800fc8:	68 6c 23 80 00       	push   $0x80236c
  800fcd:	68 13 23 80 00       	push   $0x802313
  800fd2:	6a 6d                	push   $0x6d
  800fd4:	68 60 23 80 00       	push   $0x802360
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801020:	68 78 23 80 00       	push   $0x802378
  801025:	53                   	push   %ebx
...
00801080 <_pipeisclosed>:
{
  ...
  801092:	8b 58 58             	mov    0x58(%eax),%ebx
		ret = pageref(fd) == pageref(p);
  801095:	83 ec 0c             	sub    $0xc,%esp
  801098:	57                   	push   %edi
  801099:	e8 11 0f 00 00       	call   801faf <pageref>
  80109e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  8010a1:	89 34 24             	mov    %esi,(%esp)
  8010a4:	e8 06 0f 00 00       	call   801faf <pageref>
		nn = thisenv->env_runs;
  ...
  8010c3:	50                   	push   %eax
  8010c4:	53                   	push   %ebx
  8010c5:	68 7f 23 80 00       	push   $0x80237f
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80135e:	68 97 23 80 00       	push   $0x802397
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8014e2:	56                   	push   %esi
  8014e3:	50                   	push   %eax
  8014e4:	68 a4 23 80 00       	push   $0x8023a4
  ...
  8014f5:	e8 56 00 00 00       	call   801550 <vcprintf>
	cprintf("\n");
  8014fa:	c7 04 24 90 23 80 00 	movl   $0x802390,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801603:	e8 e8 09 00 00       	call   801ff0 <__udivdi3>
  ...
  801641:	e8 ca 0a 00 00       	call   802110 <__umoddi3>
  801646:	83 c4 14             	add    $0x14,%esp
  801649:	0f be 80 c7 23 80 00 	movsbl 0x8023c7(%eax),%eax
  801650:	50                   	push   %eax
...
00801698 <vprintfmt>:
{
  ...
  8017dc:	52                   	push   %edx
  8017dd:	68 25 23 80 00       	push   $0x802325
  8017e2:	53                   	push   %ebx
  8017e3:	56                   	push   %esi
  ...
  8017f4:	50                   	push   %eax
  8017f5:	68 df 23 80 00       	push   $0x8023df
  8017fa:	53                   	push   %ebx
  8017fb:	56                   	push   %esi
  ...
  80181c:	b8 d8 23 80 00       	mov    $0x8023d8,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801ee1:	74 14                	je     801ef7 <ipc_recv+0x3c>
  801ee3:	ba 00 00 00 00       	mov    $0x0,%edx
  801ee8:	85 c0                	test   %eax,%eax
  801eea:	78 09                	js     801ef5 <ipc_recv+0x3a>
  801eec:	8b 15 00 40 80 00    	mov    0x804000,%edx
  801ef2:	8b 52 74             	mov    0x74(%edx),%edx
  801ef5:	89 16                	mov    %edx,(%esi)
	if(perm_store) *perm_store= (r<0? 0:thisenv->env_ipc_perm);
  801ef7:	85 db                	test   %ebx,%ebx
  801ef9:	74 14                	je     801f0f <ipc_recv+0x54>
  801efb:	ba 00 00 00 00       	mov    $0x0,%edx
  801f00:	85 c0                	test   %eax,%eax
  801f02:	78 09                	js     801f0d <ipc_recv+0x52>
  801f04:	8b 15 00 40 80 00    	mov    0x804000,%edx
  801f0a:	8b 52 78             	mov    0x78(%edx),%edx
  801f0d:	89 13                	mov    %edx,(%ebx)
	
	if(r<0) return r;
  801f0f:	85 c0                	test   %eax,%eax
  801f11:	78 08                	js     801f1b <ipc_recv+0x60>
	
	return thisenv->env_ipc_value;
  801f13:	a1 00 40 80 00       	mov    0x804000,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801f40:	e8 02 e2 ff ff       	call   800147 <sys_yield>
		r=sys_ipc_try_send(to_env, val, pg, perm);
  801f45:	ff 75 14             	push   0x14(%ebp)
  801f48:	53                   	push   %ebx
  801f49:	56                   	push   %esi
  801f4a:	57                   	push   %edi
  801f4b:	e8 a3 e3 ff ff       	call   8002f3 <sys_ipc_try_send>
		if( r==-E_IPC_NOT_RECV ) sys_yield();
  ...
  801f71:	e8 50 f5 ff ff       	call   8014c6 <_panic>
...
ipc_find_env(enum EnvType type)
{
  ...
  801f8f:	74 11                	je     801fa2 <ipc_find_env+0x2c>
	for (i = 0; i < NENV; i++)
  801f91:	83 c0 01             	add    $0x1,%eax
  801f94:	3d 00 04 00 00       	cmp    $0x400,%eax
  801f99:	75 e6                	jne    801f81 <ipc_find_env+0xb>
			return envs[i].env_id;
	return 0;
  801f9b:	b8 00 00 00 00       	mov    $0x0,%eax
  801fa0:	eb 0b                	jmp    801fad <ipc_find_env+0x37>
			return envs[i].env_id;
...
pageref(void *v)
{
  ...
  801fb7:	c1 ea 16             	shr    $0x16,%edx
  801fba:	8b 0c 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%ecx
		return 0;
  801fc1:	ba 00 00 00 00       	mov    $0x0,%edx
	if (!(uvpd[PDX(v)] & PTE_P))
  801fc6:	f6 c1 01             	test   $0x1,%cl
  801fc9:	74 1c                	je     801fe7 <pageref+0x38>
	pte = uvpt[PGNUM(v)];
  801fcb:	c1 e8 0c             	shr    $0xc,%eax
  801fce:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	if (!(pte & PTE_P))
  801fd5:	a8 01                	test   $0x1,%al
  801fd7:	74 0e                	je     801fe7 <pageref+0x38>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801fd9:	c1 e8 0c             	shr    $0xc,%eax
  801fdc:	0f b7 14 c5 04 00 00 	movzwl -0x10fffffc(,%eax,8),%edx
  801fe3:	ef 
  801fe4:	0f b7 d2             	movzwl %dx,%edx
}
