	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001eb:	0f be 80 68 22 80 00 	movsbl 0x802268(%eax),%eax
  8001f2:	50                   	push   %eax
...
0080023a <vprintfmt>:
{
  ...
  8002a5:	ff 24 85 a0 23 80 00 	jmp    *0x8023a0(,%eax,4)
  ...
  800373:	8b 14 85 00 25 80 00 	mov    0x802500(,%eax,4),%edx
  80037a:	85 d2                	test   %edx,%edx
  80037c:	74 18                	je     800396 <vprintfmt+0x15c>
				printfmt(putch, putdat, "%s", p);
  80037e:	52                   	push   %edx
  80037f:	68 35 26 80 00       	push   $0x802635
  800384:	53                   	push   %ebx
  800385:	56                   	push   %esi
  ...
  800396:	50                   	push   %eax
  800397:	68 80 22 80 00       	push   $0x802280
  80039c:	53                   	push   %ebx
  80039d:	56                   	push   %esi
  ...
  8003be:	b8 79 22 80 00       	mov    $0x802279,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800aca:	68 5f 25 80 00       	push   $0x80255f
  800acf:	6a 2a                	push   $0x2a
  800ad1:	68 7c 25 80 00       	push   $0x80257c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b4b:	68 5f 25 80 00       	push   $0x80255f
  800b50:	6a 2a                	push   $0x2a
  800b52:	68 7c 25 80 00       	push   $0x80257c
...
sys_ipc_recv(void *dstva)
{
  ...
  800cf9:	68 5f 25 80 00       	push   $0x80255f
  800cfe:	6a 2a                	push   $0x2a
  800d00:	68 7c 25 80 00       	push   $0x80257c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e4d:	8b 1c 85 08 26 80 00 	mov    0x802608(,%eax,4),%ebx
  ...
  800e63:	52                   	push   %edx
  800e64:	50                   	push   %eax
  800e65:	68 8c 25 80 00       	push   $0x80258c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8010b5:	56                   	push   %esi
  8010b6:	50                   	push   %eax
  8010b7:	68 cd 25 80 00       	push   $0x8025cd
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80117e:	53                   	push   %ebx
  80117f:	50                   	push   %eax
  801180:	68 e9 25 80 00       	push   $0x8025e9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801226:	53                   	push   %ebx
  801227:	50                   	push   %eax
  801228:	68 ac 25 80 00       	push   $0x8025ac
...
0080142c <devfile_read>:
{
  ...
  801481:	c3                   	ret    
	assert(r <= n);
  801482:	68 1c 26 80 00       	push   $0x80261c
  801487:	68 23 26 80 00       	push   $0x802623
  80148c:	6a 7c                	push   $0x7c
  80148e:	68 38 26 80 00       	push   $0x802638
  801493:	e8 e1 09 00 00       	call   801e79 <_panic>
	assert(r <= PGSIZE);
  801498:	68 43 26 80 00       	push   $0x802643
  80149d:	68 23 26 80 00       	push   $0x802623
  8014a2:	6a 7d                	push   $0x7d
  8014a4:	68 38 26 80 00       	push   $0x802638
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801559:	68 4f 26 80 00       	push   $0x80264f
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  80191c:	c3                   	ret    
		assert(r < 1600 && r <= len);
  80191d:	68 5b 26 80 00       	push   $0x80265b
  801922:	68 23 26 80 00       	push   $0x802623
  801927:	6a 62                	push   $0x62
  801929:	68 70 26 80 00       	push   $0x802670
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  80197a:	c3                   	ret    
	assert(size < 1600);
  80197b:	68 7c 26 80 00       	push   $0x80267c
  801980:	68 23 26 80 00       	push   $0x802623
  801985:	6a 6d                	push   $0x6d
  801987:	68 70 26 80 00       	push   $0x802670
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8019d3:	68 88 26 80 00       	push   $0x802688
  8019d8:	53                   	push   %ebx
...
00801a33 <_pipeisclosed>:
{
  ...
  801a76:	50                   	push   %eax
  801a77:	53                   	push   %ebx
  801a78:	68 8f 26 80 00       	push   $0x80268f
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801d11:	68 a7 26 80 00       	push   $0x8026a7
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801e95:	56                   	push   %esi
  801e96:	50                   	push   %eax
  801e97:	68 b4 26 80 00       	push   $0x8026b4
  ...
  801ea8:	e8 45 e2 ff ff       	call   8000f2 <vcprintf>
	cprintf("\n");
  801ead:	c7 04 24 5c 22 80 00 	movl   $0x80225c,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801f68:	50                   	push   %eax
  801f69:	68 d7 26 80 00       	push   $0x8026d7
  801f6e:	6a 3d                	push   $0x3d
  801f70:	68 eb 26 80 00       	push   $0x8026eb
