	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ee:	0f be 80 91 22 80 00 	movsbl 0x802291(%eax),%eax
  8001f5:	50                   	push   %eax
...
0080023d <vprintfmt>:
{
  ...
  8002a8:	ff 24 85 e0 23 80 00 	jmp    *0x8023e0(,%eax,4)
  ...
  800381:	52                   	push   %edx
  800382:	68 75 26 80 00       	push   $0x802675
  800387:	53                   	push   %ebx
  800388:	56                   	push   %esi
  ...
  800399:	50                   	push   %eax
  80039a:	68 a9 22 80 00       	push   $0x8022a9
  80039f:	53                   	push   %ebx
  8003a0:	56                   	push   %esi
  ...
  8003c1:	b8 a2 22 80 00       	mov    $0x8022a2,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800acd:	68 9f 25 80 00       	push   $0x80259f
  800ad2:	6a 2a                	push   $0x2a
  800ad4:	68 bc 25 80 00       	push   $0x8025bc
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b4e:	68 9f 25 80 00       	push   $0x80259f
  800b53:	6a 2a                	push   $0x2a
  800b55:	68 bc 25 80 00       	push   $0x8025bc
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b90:	68 9f 25 80 00       	push   $0x80259f
  800b95:	6a 2a                	push   $0x2a
  800b97:	68 bc 25 80 00       	push   $0x8025bc
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bd2:	68 9f 25 80 00       	push   $0x80259f
  800bd7:	6a 2a                	push   $0x2a
  800bd9:	68 bc 25 80 00       	push   $0x8025bc
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c14:	68 9f 25 80 00       	push   $0x80259f
  800c19:	6a 2a                	push   $0x2a
  800c1b:	68 bc 25 80 00       	push   $0x8025bc
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c56:	68 9f 25 80 00       	push   $0x80259f
  800c5b:	6a 2a                	push   $0x2a
  800c5d:	68 bc 25 80 00       	push   $0x8025bc
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c98:	68 9f 25 80 00       	push   $0x80259f
  800c9d:	6a 2a                	push   $0x2a
  800c9f:	68 bc 25 80 00       	push   $0x8025bc
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e50:	8b 1c 85 48 26 80 00 	mov    0x802648(,%eax,4),%ebx
  ...
  800e66:	52                   	push   %edx
  800e67:	50                   	push   %eax
  800e68:	68 cc 25 80 00       	push   $0x8025cc
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8010b8:	56                   	push   %esi
  8010b9:	50                   	push   %eax
  8010ba:	68 0d 26 80 00       	push   $0x80260d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801181:	53                   	push   %ebx
  801182:	50                   	push   %eax
  801183:	68 29 26 80 00       	push   $0x802629
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801229:	53                   	push   %ebx
  80122a:	50                   	push   %eax
  80122b:	68 ec 25 80 00       	push   $0x8025ec
...
0080142f <devfile_read>:
{
  ...
  801484:	c3                   	ret    
	assert(r <= n);
  801485:	68 5c 26 80 00       	push   $0x80265c
  80148a:	68 63 26 80 00       	push   $0x802663
  80148f:	6a 7c                	push   $0x7c
  801491:	68 78 26 80 00       	push   $0x802678
  801496:	e8 e1 09 00 00       	call   801e7c <_panic>
	assert(r <= PGSIZE);
  80149b:	68 83 26 80 00       	push   $0x802683
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80155c:	68 8f 26 80 00       	push   $0x80268f
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  80191f:	c3                   	ret    
		assert(r < 1600 && r <= len);
  801920:	68 9b 26 80 00       	push   $0x80269b
  801925:	68 63 26 80 00       	push   $0x802663
  80192a:	6a 62                	push   $0x62
  80192c:	68 b0 26 80 00       	push   $0x8026b0
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  80197d:	c3                   	ret    
	assert(size < 1600);
  80197e:	68 bc 26 80 00       	push   $0x8026bc
  801983:	68 63 26 80 00       	push   $0x802663
  801988:	6a 6d                	push   $0x6d
  80198a:	68 b0 26 80 00       	push   $0x8026b0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8019d6:	68 c8 26 80 00       	push   $0x8026c8
  8019db:	53                   	push   %ebx
...
00801a36 <_pipeisclosed>:
{
  ...
  801a79:	50                   	push   %eax
  801a7a:	53                   	push   %ebx
  801a7b:	68 cf 26 80 00       	push   $0x8026cf
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801d14:	68 e7 26 80 00       	push   $0x8026e7
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801e98:	56                   	push   %esi
  801e99:	50                   	push   %eax
  801e9a:	68 f4 26 80 00       	push   $0x8026f4
  ...
  801eab:	e8 45 e2 ff ff       	call   8000f5 <vcprintf>
	cprintf("\n");
  801eb0:	c7 04 24 e0 26 80 00 	movl   $0x8026e0,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801f74:	50                   	push   %eax
  801f75:	68 17 27 80 00       	push   $0x802717
  801f7a:	6a 3d                	push   $0x3d
  801f7c:	68 2b 27 80 00       	push   $0x80272b
