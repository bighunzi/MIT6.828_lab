...
umain(int argc, char **argv)
{
  ...
  800040:	22 80 00 
	...
	while (1) {
		sys_yield();
  800043:	e8 02 01 00 00       	call   80014a <sys_yield>
...
sys_env_destroy(envid_t envid)
{
  ...
  80011a:	68 4f 22 80 00       	push   $0x80224f
  80011f:	6a 2a                	push   $0x2a
  800121:	68 6c 22 80 00       	push   $0x80226c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80019b:	68 4f 22 80 00       	push   $0x80224f
  8001a0:	6a 2a                	push   $0x2a
  8001a2:	68 6c 22 80 00       	push   $0x80226c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001dd:	68 4f 22 80 00       	push   $0x80224f
  8001e2:	6a 2a                	push   $0x2a
  8001e4:	68 6c 22 80 00       	push   $0x80226c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80021f:	68 4f 22 80 00       	push   $0x80224f
  800224:	6a 2a                	push   $0x2a
  800226:	68 6c 22 80 00       	push   $0x80226c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800261:	68 4f 22 80 00       	push   $0x80224f
  800266:	6a 2a                	push   $0x2a
  800268:	68 6c 22 80 00       	push   $0x80226c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002a3:	68 4f 22 80 00       	push   $0x80224f
  8002a8:	6a 2a                	push   $0x2a
  8002aa:	68 6c 22 80 00       	push   $0x80226c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002e5:	68 4f 22 80 00       	push   $0x80224f
  8002ea:	6a 2a                	push   $0x2a
  8002ec:	68 6c 22 80 00       	push   $0x80226c
...
sys_ipc_recv(void *dstva)
{
  ...
  800349:	68 4f 22 80 00       	push   $0x80224f
  80034e:	6a 2a                	push   $0x2a
  800350:	68 6c 22 80 00       	push   $0x80226c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80049d:	8b 1c 85 f8 22 80 00 	mov    0x8022f8(,%eax,4),%ebx
  ...
  8004b3:	52                   	push   %edx
  8004b4:	50                   	push   %eax
  8004b5:	68 7c 22 80 00       	push   $0x80227c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800705:	56                   	push   %esi
  800706:	50                   	push   %eax
  800707:	68 bd 22 80 00       	push   $0x8022bd
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8007ce:	53                   	push   %ebx
  8007cf:	50                   	push   %eax
  8007d0:	68 d9 22 80 00       	push   $0x8022d9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800876:	53                   	push   %ebx
  800877:	50                   	push   %eax
  800878:	68 9c 22 80 00       	push   $0x80229c
...
00800a7c <devfile_read>:
{
  ...
  800ad1:	c3                   	ret    
	assert(r <= n);
  800ad2:	68 0c 23 80 00       	push   $0x80230c
  800ad7:	68 13 23 80 00       	push   $0x802313
  800adc:	6a 7c                	push   $0x7c
  800ade:	68 28 23 80 00       	push   $0x802328
  800ae3:	e8 e1 09 00 00       	call   8014c9 <_panic>
	assert(r <= PGSIZE);
  800ae8:	68 33 23 80 00       	push   $0x802333
  800aed:	68 13 23 80 00       	push   $0x802313
  800af2:	6a 7d                	push   $0x7d
  800af4:	68 28 23 80 00       	push   $0x802328
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ba9:	68 3f 23 80 00       	push   $0x80233f
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  800f6c:	c3                   	ret    
		assert(r < 1600 && r <= len);
  800f6d:	68 4b 23 80 00       	push   $0x80234b
  800f72:	68 13 23 80 00       	push   $0x802313
  800f77:	6a 62                	push   $0x62
  800f79:	68 60 23 80 00       	push   $0x802360
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  800fca:	c3                   	ret    
	assert(size < 1600);
  800fcb:	68 6c 23 80 00       	push   $0x80236c
  800fd0:	68 13 23 80 00       	push   $0x802313
  800fd5:	6a 6d                	push   $0x6d
  800fd7:	68 60 23 80 00       	push   $0x802360
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801023:	68 78 23 80 00       	push   $0x802378
  801028:	53                   	push   %ebx
...
00801083 <_pipeisclosed>:
{
  ...
  8010c6:	50                   	push   %eax
  8010c7:	53                   	push   %ebx
  8010c8:	68 7f 23 80 00       	push   $0x80237f
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801361:	68 97 23 80 00       	push   $0x802397
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8014e5:	56                   	push   %esi
  8014e6:	50                   	push   %eax
  8014e7:	68 a4 23 80 00       	push   $0x8023a4
  ...
  8014f8:	e8 56 00 00 00       	call   801553 <vcprintf>
	cprintf("\n");
  8014fd:	c7 04 24 90 23 80 00 	movl   $0x802390,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80164c:	0f be 80 c7 23 80 00 	movsbl 0x8023c7(%eax),%eax
  801653:	50                   	push   %eax
...
0080169b <vprintfmt>:
{
  ...
  8017df:	52                   	push   %edx
  8017e0:	68 25 23 80 00       	push   $0x802325
  8017e5:	53                   	push   %ebx
  8017e6:	56                   	push   %esi
  ...
  8017f7:	50                   	push   %eax
  8017f8:	68 df 23 80 00       	push   $0x8023df
  8017fd:	53                   	push   %ebx
  8017fe:	56                   	push   %esi
  ...
  80181f:	b8 d8 23 80 00       	mov    $0x8023d8,%eax
