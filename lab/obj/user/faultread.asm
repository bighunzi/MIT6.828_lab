	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800236:	0f be 84 03 9c ee ff 	movsbl -0x1164(%ebx,%eax,1),%eax
  80023d:	ff 
  80023e:	50                   	push   %eax
...
00800286 <vprintfmt>:
{
  ...
  800312:	03 b4 81 2c ef ff ff 	add    -0x10d4(%ecx,%eax,4),%esi
...
008003d5 <.L28>:
  ...
  8003fa:	8d 80 bd ee ff ff    	lea    -0x1143(%eax),%eax
  800400:	50                   	push   %eax
  800401:	57                   	push   %edi
  800402:	56                   	push   %esi
  ...
  800417:	8d 80 b4 ee ff ff    	lea    -0x114c(%eax),%eax
  80041d:	50                   	push   %eax
  80041e:	57                   	push   %edi
  80041f:	56                   	push   %esi
...
00800430 <.L24>:
  ...
  800446:	8d 80 ad ee ff ff    	lea    -0x1153(%eax),%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ba3:	8d 83 84 f0 ff ff    	lea    -0xf7c(%ebx),%eax
  800ba9:	50                   	push   %eax
  800baa:	6a 23                	push   $0x23
  800bac:	8d 83 a1 f0 ff ff    	lea    -0xf5f(%ebx),%eax
  800bb2:	50                   	push   %eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c04:	57                   	push   %edi
  800c05:	50                   	push   %eax
  800c06:	8d 83 b0 f0 ff ff    	lea    -0xf50(%ebx),%eax
  800c0c:	50                   	push   %eax
  ...
  800c19:	e8 fa f4 ff ff       	call   800118 <vcprintf>
	cprintf("\n");
  800c1e:	8d 83 90 ee ff ff    	lea    -0x1170(%ebx),%eax
