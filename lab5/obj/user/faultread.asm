	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001eb:	0f be 80 a8 1d 80 00 	movsbl 0x801da8(%eax),%eax
  8001f2:	50                   	push   %eax
...
0080023a <vprintfmt>:
{
  ...
  8002a5:	ff 24 85 e0 1e 80 00 	jmp    *0x801ee0(,%eax,4)
  ...
  800373:	8b 14 85 40 20 80 00 	mov    0x802040(,%eax,4),%edx
  80037a:	85 d2                	test   %edx,%edx
  80037c:	74 18                	je     800396 <vprintfmt+0x15c>
				printfmt(putch, putdat, "%s", p);
  80037e:	52                   	push   %edx
  80037f:	68 71 21 80 00       	push   $0x802171
  800384:	53                   	push   %ebx
  800385:	56                   	push   %esi
  ...
  800396:	50                   	push   %eax
  800397:	68 c0 1d 80 00       	push   $0x801dc0
  80039c:	53                   	push   %ebx
  80039d:	56                   	push   %esi
  ...
  8003be:	b8 b9 1d 80 00       	mov    $0x801db9,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800aca:	68 9f 20 80 00       	push   $0x80209f
  800acf:	6a 2a                	push   $0x2a
  800ad1:	68 bc 20 80 00       	push   $0x8020bc
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b4b:	68 9f 20 80 00       	push   $0x80209f
  800b50:	6a 2a                	push   $0x2a
  800b52:	68 bc 20 80 00       	push   $0x8020bc
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b8d:	68 9f 20 80 00       	push   $0x80209f
  800b92:	6a 2a                	push   $0x2a
  800b94:	68 bc 20 80 00       	push   $0x8020bc
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bcf:	68 9f 20 80 00       	push   $0x80209f
  800bd4:	6a 2a                	push   $0x2a
  800bd6:	68 bc 20 80 00       	push   $0x8020bc
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c11:	68 9f 20 80 00       	push   $0x80209f
  800c16:	6a 2a                	push   $0x2a
  800c18:	68 bc 20 80 00       	push   $0x8020bc
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c53:	68 9f 20 80 00       	push   $0x80209f
  800c58:	6a 2a                	push   $0x2a
  800c5a:	68 bc 20 80 00       	push   $0x8020bc
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c95:	68 9f 20 80 00       	push   $0x80209f
  800c9a:	6a 2a                	push   $0x2a
  800c9c:	68 bc 20 80 00       	push   $0x8020bc
...
sys_ipc_recv(void *dstva)
{
  ...
  800cf9:	68 9f 20 80 00       	push   $0x80209f
  800cfe:	6a 2a                	push   $0x2a
  800d00:	68 bc 20 80 00       	push   $0x8020bc
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800ddb:	b8 48 21 80 00       	mov    $0x802148,%eax
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800dfd:	52                   	push   %edx
  800dfe:	50                   	push   %eax
  800dff:	68 cc 20 80 00       	push   $0x8020cc
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80104f:	56                   	push   %esi
  801050:	50                   	push   %eax
  801051:	68 0d 21 80 00       	push   $0x80210d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801118:	53                   	push   %ebx
  801119:	50                   	push   %eax
  80111a:	68 29 21 80 00       	push   $0x802129
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8011c0:	53                   	push   %ebx
  8011c1:	50                   	push   %eax
  8011c2:	68 ec 20 80 00       	push   $0x8020ec
...
008013c6 <devfile_read>:
{
  ...
  80141b:	c3                   	ret    
	assert(r <= n);
  80141c:	68 58 21 80 00       	push   $0x802158
  801421:	68 5f 21 80 00       	push   $0x80215f
  801426:	6a 7c                	push   $0x7c
  801428:	68 74 21 80 00       	push   $0x802174
  80142d:	e8 79 05 00 00       	call   8019ab <_panic>
	assert(r <= PGSIZE);
  801432:	68 7f 21 80 00       	push   $0x80217f
  801437:	68 5f 21 80 00       	push   $0x80215f
  80143c:	6a 7d                	push   $0x7d
  80143e:	68 74 21 80 00       	push   $0x802174
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801505:	68 8b 21 80 00       	push   $0x80218b
  80150a:	53                   	push   %ebx
...
00801565 <_pipeisclosed>:
{
  ...
  8015a8:	50                   	push   %eax
  8015a9:	53                   	push   %ebx
  8015aa:	68 92 21 80 00       	push   $0x802192
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801843:	68 aa 21 80 00       	push   $0x8021aa
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8019c7:	56                   	push   %esi
  8019c8:	50                   	push   %eax
  8019c9:	68 b8 21 80 00       	push   $0x8021b8
  ...
  8019da:	e8 13 e7 ff ff       	call   8000f2 <vcprintf>
	cprintf("\n");
  8019df:	c7 04 24 9c 1d 80 00 	movl   $0x801d9c,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801a9a:	50                   	push   %eax
  801a9b:	68 db 21 80 00       	push   $0x8021db
  801aa0:	6a 3d                	push   $0x3d
  801aa2:	68 ef 21 80 00       	push   $0x8021ef
