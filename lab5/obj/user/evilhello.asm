...
sys_env_destroy(envid_t envid)
{
  ...
  800117:	68 6a 1d 80 00       	push   $0x801d6a
  80011c:	6a 2a                	push   $0x2a
  80011e:	68 87 1d 80 00       	push   $0x801d87
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800198:	68 6a 1d 80 00       	push   $0x801d6a
  80019d:	6a 2a                	push   $0x2a
  80019f:	68 87 1d 80 00       	push   $0x801d87
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001da:	68 6a 1d 80 00       	push   $0x801d6a
  8001df:	6a 2a                	push   $0x2a
  8001e1:	68 87 1d 80 00       	push   $0x801d87
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80021c:	68 6a 1d 80 00       	push   $0x801d6a
  800221:	6a 2a                	push   $0x2a
  800223:	68 87 1d 80 00       	push   $0x801d87
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80025e:	68 6a 1d 80 00       	push   $0x801d6a
  800263:	6a 2a                	push   $0x2a
  800265:	68 87 1d 80 00       	push   $0x801d87
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002a0:	68 6a 1d 80 00       	push   $0x801d6a
  8002a5:	6a 2a                	push   $0x2a
  8002a7:	68 87 1d 80 00       	push   $0x801d87
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002e2:	68 6a 1d 80 00       	push   $0x801d6a
  8002e7:	6a 2a                	push   $0x2a
  8002e9:	68 87 1d 80 00       	push   $0x801d87
...
sys_ipc_recv(void *dstva)
{
  ...
  800346:	68 6a 1d 80 00       	push   $0x801d6a
  80034b:	6a 2a                	push   $0x2a
  80034d:	68 87 1d 80 00       	push   $0x801d87
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800428:	b8 14 1e 80 00       	mov    $0x801e14,%eax
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  80044a:	52                   	push   %edx
  80044b:	50                   	push   %eax
  80044c:	68 98 1d 80 00       	push   $0x801d98
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80069c:	56                   	push   %esi
  80069d:	50                   	push   %eax
  80069e:	68 d9 1d 80 00       	push   $0x801dd9
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800765:	53                   	push   %ebx
  800766:	50                   	push   %eax
  800767:	68 f5 1d 80 00       	push   $0x801df5
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80080d:	53                   	push   %ebx
  80080e:	50                   	push   %eax
  80080f:	68 b8 1d 80 00       	push   $0x801db8
...
00800a13 <devfile_read>:
{
  ...
  800a68:	c3                   	ret    
	assert(r <= n);
  800a69:	68 24 1e 80 00       	push   $0x801e24
  800a6e:	68 2b 1e 80 00       	push   $0x801e2b
  800a73:	6a 7c                	push   $0x7c
  800a75:	68 40 1e 80 00       	push   $0x801e40
  800a7a:	e8 79 05 00 00       	call   800ff8 <_panic>
	assert(r <= PGSIZE);
  800a7f:	68 4b 1e 80 00       	push   $0x801e4b
  800a84:	68 2b 1e 80 00       	push   $0x801e2b
  800a89:	6a 7d                	push   $0x7d
  800a8b:	68 40 1e 80 00       	push   $0x801e40
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b52:	68 57 1e 80 00       	push   $0x801e57
  800b57:	53                   	push   %ebx
...
00800bb2 <_pipeisclosed>:
{
  ...
  800bf5:	50                   	push   %eax
  800bf6:	53                   	push   %ebx
  800bf7:	68 5e 1e 80 00       	push   $0x801e5e
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800e90:	68 76 1e 80 00       	push   $0x801e76
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801014:	56                   	push   %esi
  801015:	50                   	push   %eax
  801016:	68 84 1e 80 00       	push   $0x801e84
  ...
  801027:	e8 56 00 00 00       	call   801082 <vcprintf>
	cprintf("\n");
  80102c:	c7 04 24 6f 1e 80 00 	movl   $0x801e6f,(%esp)
...
008011ca <vprintfmt>:
{
  ...
  80130e:	52                   	push   %edx
  80130f:	68 3d 1e 80 00       	push   $0x801e3d
  801314:	53                   	push   %ebx
  801315:	56                   	push   %esi
  ...
  801326:	50                   	push   %eax
  801327:	68 bf 1e 80 00       	push   $0x801ebf
  80132c:	53                   	push   %ebx
  80132d:	56                   	push   %esi
  ...
  80134e:	b8 b8 1e 80 00       	mov    $0x801eb8,%eax
