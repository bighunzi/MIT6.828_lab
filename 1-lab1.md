...
所以参考：https://zhuanlan.zhihu.com/p/168787600. 在kern/moniter.c  mon_backtrace()函数中添加了这两行代码并调试。
从boj/kernel.asm中可以看到mon_backtrace()入口在 f0100877（1055行），而后续练习的代码自f0100895开始，所以将。根据练习写入的程序在
```language
(gdb) p fmt
